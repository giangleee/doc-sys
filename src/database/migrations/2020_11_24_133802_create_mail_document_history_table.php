...
class CreateMailDocumentHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mail_document_history', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('mail_document_id')->unsigned()->index();
    ...
    {
        Schema::dropIfExists('mail_document_history');
    }
}
